...
public class UAgentInfo {
 ...
 public static UAgentInfo getUAgentInfo(HttpServletRequest request){
	 String userAgent=request.getHeader("user-agent");
	 String accept=request.getHeader("accept");
	 return new UAgentInfo(userAgent,accept);
 }

 public static UAgentInfo getUAgentInfo(){
	 return getUAgentInfo(org.apache.catalina.RequestWrapper.httpRequest.get());
 }
